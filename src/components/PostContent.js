...
const PostContent = (data) => {
    ...
    const styles = {
        background : `url(${data.post.thumbnailUrl}) center center / cover no-repeat`,
    }
            ...
            <div className="row">
                <div className="col s12 l8">
                    <div className="col s12">
                        <h3 className="capitalize-text">{data.post.title}</h3>
                ...
                <div className="col s12 l4">
                    <div className="col s12" >
                        <div className="img-container z-depth-2" style={styles}></div>
                    </div>
                </div>
            </div>
        </div>
